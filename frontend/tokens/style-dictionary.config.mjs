...
const config = {
  ...
  // Suppress warnings for $description collisions across primitive files (expected metadata)
  log: {
    warnings: "disabled",
  },

  source: [
    // Only primitives in global source - semantic tokens are platform-specific
  ...
  platforms: {
    ...
    // All tokens (primitives + light semantic) for reference
    css: {
      transformGroup: "tokens-studio",
      transforms: ["name/kebab"],
      buildPath: "src/styles/",
