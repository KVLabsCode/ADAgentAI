  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        // Subtle: transparent background with subtle hover state
        subtle:
          "bg-transparent text-[color:var(--btn-ghost-color)] border-[length:var(--btn-border-width)] border-transparent hover:bg-[var(--btn-ghost-hover-bg)] transition-colors duration-150",
      },
      size: {
        default: "h-9 px-4 py-2 has-[>svg]:px-3",
        // Small: 32px height, 13px font, 14px padding, 5px radius (design system)
        sm: "h-[var(--btn-height-sm)] px-[var(--btn-padding-x)] rounded-[var(--btn-radius)] text-[length:var(--btn-font-size)] font-[var(--btn-font-weight)] gap-1.5",
