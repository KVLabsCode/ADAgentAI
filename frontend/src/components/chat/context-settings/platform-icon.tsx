...
// Android icon SVG - hoisted outside component to prevent recreation
const AndroidIcon = (
...
// iOS icon SVG - hoisted outside component to prevent recreation
const IOSIcon = (
...
/**
 * Platform icon component for Android/iOS.
  ...
  return (
    <div
      className={cn(
        ...
        isAndroid ? "bg-emerald-500/20" : "bg-blue-500/20"
      )}
      title={isAndroid ? "Android" : "iOS"}
    >
      {isAndroid ? AndroidIcon : IOSIcon}
    </div>
  )
})
